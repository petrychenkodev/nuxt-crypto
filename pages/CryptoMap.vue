    ...
    <section class="crypto-regulations bg-[#0d1117] text-white p-6 min-h-screen">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-[#161b22] rounded-lg">
          ...
          <tbody>
            <tr v-for="country in filteredCountries" :key="country.cca2" class="border-t border-gray-700">
              <td class="py-3 px-6">
                <img :src="country.flags.png" :alt="country.name.common" class="w-8 h-5 object-cover" />
              </td>
